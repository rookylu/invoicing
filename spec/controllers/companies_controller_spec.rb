...
describe CompaniesController do
  ...
  describe "GET index" do
    it "assigns all companies as @companies" do
      Company.stub!(:find).with(:all).and_return([mock_company])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested company as @company" do
      Company.stub!(:find).with("37").and_return(mock_company)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new company as @company" do
      Company.stub!(:new).and_return(mock_company)
      get :new
      assigns[:company].should equal(mock_company)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created company as @company" do
        Company.stub!(:new).with({'these' => 'params'}).and_return(mock_company(:save => true))
